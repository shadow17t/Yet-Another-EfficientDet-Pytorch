...
from efficientdet.modellite import BiFPN, Regressor, Classifier, EfficientNetLitePlus, EfficientNetLite
...
class EfficientDetLiteBackbonePlus(nn.Module):
    def __init__(self, num_classes=80, compound_coef=0, load_weights=False, **kwargs):
        super(EfficientDetLiteBackbonePlus, self).__init__()
        self.compound_coef = compound_coef
        ...
        self.backbone_net = EfficientNetLitePlus(self.backbone_compound_coef[compound_coef], load_weights)
...
class MiniEfficientDetLiteBackbonePlus(nn.Module):
    def __init__(self, num_classes=80, compound_coef=0, load_weights=False, **kwargs):
        super(MiniEfficientDetLiteBackbonePlus, self).__init__()
        self.compound_coef = compound_coef

        self.backbone_compound_coef = [0, 1, 2, 3, 4]
        self.fpn_num_filters = [64, 88, 112, 160, 224]
        self.fpn_cell_repeats = [1, 1, 1, 1, 1] #mini
        self.input_sizes = [512, 640, 768, 896, 1024]#[320, 384, 448, 512, 640] #
        self.box_class_repeats = [3, 3, 3, 4, 4]
        self.pyramid_levels = [5, 5, 5, 5, 5]
        self.anchor_scale = [3., 3., 3., 3., 3.]
