...
from backbonelite import MiniEfficientDetLiteBackbone, EfficientDetLiteBackbone, MiniSkipEfficientDetLiteBackbone, SkipEfficientDetLiteBackbone
...
weights_path = f'weights/efficientdet_lite{compound_coef}.pth' if args.weights is None else args.weights
...
if __name__ == '__main__':
    ...
    if override_prev_results or not os.path.exists(f'{SET_NAME}_bbox_results.json'):
        model = SkipEfficientDetLiteBackbone(compound_coef=compound_coef, num_classes=len(obj_list),
